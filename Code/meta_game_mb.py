...
agent_ARC = ARCPricingModel(candidate_margins=action_set,
                            rho=0.02, beta=0.99)
...
for agent_pair in agent_pairs:
    ...
    plt.savefig(
        f'meta_game_mb_images/game_sim{no_sim}_T{T}_a1{agent1_name}_agent2{agent2_name}.png')
    plt.close()
