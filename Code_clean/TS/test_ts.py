...
filename = 'ts_vs_fixed_action'
title = f'Classic TS vs Fixed-Action Agent {fixed_action}'
...
ut.print_result_to_file(reward_1_sum, reward_2_sum, os.path.join(
    result_folder, filename + '.txt'), 'Classic TS', 'Fixed-Action Agent')
...
ut.plot_smooth_reward_history(
    reward_history, bandit1_name='Classic TS',
