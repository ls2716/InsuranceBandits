...
filename = 'eps_greedy_vs_fixed_action'
title = f'Classic Epsilon Greedy vs Fixed-Action Agent {fixed_action}'
...
ut.print_result_to_file(reward_1_sum, reward_2_sum, os.path.join(
    result_folder, filename + '.txt'), 'Classic Eps-Greedy', 'Fixed-Action Agent')
