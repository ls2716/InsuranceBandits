...
from envs import InsuranceMarketCtNs

from meta.agents import agent_dict, action_set, no_actions
...
# action_set = np.linspace(0., 0.4, no_actions, endpoint=True)  # Action set


# Plotting parameters
base_foldername = f'images/meta_ns_{no_actions}'
base_result_folder = f'results/meta_ns_{no_actions}'


# Initialize the environment
env = InsuranceMarketCtNs(
    **params['ns_environment_parameters_2'])  # Environment
...
agent_pairs = [
    ('epsgreedy_classic_ns_0.99', 'epsgreedy_logistic_ns_0.95'),
    ('epsgreedy_classic_ns_0.95', 'epsgreedy_logistic_ns_0.99'),
    # ('epsgreedy_classic_ns_0.95', 'epsgreedy_logistic_nssw_200'),
    # ('epsgreedy_classic_ns_0.95', 'epsgreedy_logistic_ns_0.99'),
    # ('epsgreedy_classic_ns_0.95', 'epsgreedy_classic_ns_0.95'),
    ('epsgreedy_classic_ns_0.99', 'epsgreedy_logistic_ns_0.99'),
