"""This file contains test of nonstationary posterior model with sliding window.
"""
import numpy as np
...
filename = 'sliding_window_test.png'
title = f'Non-stationary (sliding window {tau}) Logistic Model Test'
