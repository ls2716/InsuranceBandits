...
from models import StationaryClassicModel, plot_classic
...
# Plotting parameters
foldername = 'images/model_tests/stationary_classic'
filename = 'test.png'
title = f'Stationary Classic Model Test'

# Initialize stationary model
model = StationaryClassicModel(1,
