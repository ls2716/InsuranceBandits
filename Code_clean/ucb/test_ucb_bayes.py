...
filename = 'ucb_bayes_vs_fixed_action'
title = f'Classic UCB-Bayes vs Fixed-Action Agent {fixed_action}'
...
ut.print_result_to_file(reward_1_sum, reward_2_sum, os.path.join(
    result_folder, filename + '.txt'), 'Classic UCB-Bayes', 'Fixed-Action Agent')
