...
filename = 'ucb_bayes_mb_nssw_vs_fixed_action'
title = f'NS-SW Model-based UCB-Bayes vs Fixed-Action Agent {fixed_action}'
...
ut.plot_reward_history(
    reward_history, bandit1_name='NS-SW Model-based UCB-Bayes',
