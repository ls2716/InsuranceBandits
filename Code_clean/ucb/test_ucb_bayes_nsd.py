...
filename = 'ucb_bayes_nsd_vs_fixed_action'
title = f'NS-d Classic UCB-Bayes vs Fixed-Action Agent {fixed_action}'
...
ut.plot_reward_history(
    reward_history, bandit1_name='NS-d Classic UCB-Bayes',
