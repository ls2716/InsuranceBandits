...
filename = 'ucb_mb_ns_vs_ucb_cl_ns_sw'
title = f'Ns Model-based UCB-Bayes vs Classic UCB-Bayes \n quantile {quantile} tau={tau}'
...
start_plot_index = 10
title_mb = f'Ns Model-based UCB-Bayes quantile={quantile}'
title_cl = f'Ns Classic UCB-Bayes quantile={quantile}'
...
ut.plot_reward_history(
    reward_history, bandit1_name='Ns Model-based UCB-Bayes',
    bandit2_name='Ns Classical UCB-Bayes', foldername=foldername, filename=filename, title=title)
