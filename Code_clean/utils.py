...
def plot_action_history(action_set, action_history, foldername, filename, title, show_plot=True):
    plt.figure(figsize=(5, 5))
...
def print_result_to_file(cumulative_reward_1, cumulative_reward_2, filename, agent1_name, agent2_name):
    with open(filename, 'a+') as file:
        file.write('----------------------------------------\n')
        file.write(f'{agent1_name} reward = {cumulative_reward_1:.2f}\n')
        file.write(f'{agent2_name} reward = {cumulative_reward_2:.2f}\n')
